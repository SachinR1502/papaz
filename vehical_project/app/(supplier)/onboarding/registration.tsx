...
export default function SupplierRegistration() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            // Map shopName to storeName for backend compatibility
            ...
            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
                <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.header}>
                        ...
                        <Text style={[styles.title, { color: colors.text }]}>Partner Registration</Text>
                        <Text style={[styles.subtitle, { color: colors.icon }]}>Join the premium network of verified auto parts suppliers.</Text>
                    </View>
                    ...
                    <View style={styles.formContainer}>
                        ...
                        <TouchableOpacity onPress={() => router.replace('/(auth)/login')} style={{ marginTop: 20, alignItems: 'center' }}>
                            <Text style={{ color: colors.icon, fontSize: 13 }}>Already registered? <Text style={{ color: colors.primary, fontWeight: 'bold' }}>Login here</Text></Text>
                        </TouchableOpacity>
                    </View>
