...
const CustomTabBar = ({ state, descriptors, navigation }: any) => {
    ...
    const colors = {
        ...
        active: Colors[colorScheme ?? 'light'].sales, // Green for Customer
        inactive: Colors[colorScheme ?? 'light'].icon,
        shadow: Colors[colorScheme ?? 'light'].shadow,
        slidingIndicator: isDark ? Colors.dark.border : '#F2F2F7',
    };
    ...
    return (
        <View style={[styles.tabBarContainer, {
            ...
            {state.routes.map((route: any, index: number) => {
                ...
                else if (route.name === 'request-product') iconName = isFocused ? 'basket' : 'basket-outline';
...
export default function CustomerTabLayout() {
    return (
        ...
        >
            ...
            <Tabs.Screen name="vehicles" options={{ title: 'My Vehicle' }} />
            <Tabs.Screen name="history" options={{ title: 'My History' }} />
            <Tabs.Screen name="request-product" options={{ title: 'Store' }} />
